...
// checks if the CheckBatchStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CheckBatchStatus{}

// CheckBatchStatus struct for CheckBatchStatus
...
type _CheckBatchStatus CheckBatchStatus
...
func (o CheckBatchStatus) MarshalJSON() ([]byte, error) {
...
func (o CheckBatchStatus) ToMap() (map[string]interface{}, error) {
...
func (o *CheckBatchStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varCheckBatchStatus := _CheckBatchStatus{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCheckBatchStatus)

	if err != nil {
		return err
	}

	*o = CheckBatchStatus(varCheckBatchStatus)

	return err
}

type NullableCheckBatchStatus struct {
	value *CheckBatchStatus
	isSet bool
}

func (v NullableCheckBatchStatus) Get() *CheckBatchStatus {
	return v.value
}

func (v *NullableCheckBatchStatus) Set(val *CheckBatchStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableCheckBatchStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableCheckBatchStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCheckBatchStatus(val *CheckBatchStatus) *NullableCheckBatchStatus {
	return &NullableCheckBatchStatus{value: val, isSet: true}
}

func (v NullableCheckBatchStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCheckBatchStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
