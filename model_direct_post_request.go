...
// checks if the DirectPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectPostRequest{}

// DirectPostRequest struct for DirectPostRequest
...
func (o DirectPostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *DirectPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varDirectPostRequest := _DirectPostRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDirectPostRequest)

	if err != nil {
		return err
	}

	*o = DirectPostRequest(varDirectPostRequest)

	return err
}

type NullableDirectPostRequest struct {
	value *DirectPostRequest
	isSet bool
}

func (v NullableDirectPostRequest) Get() *DirectPostRequest {
	return v.value
}

func (v *NullableDirectPostRequest) Set(val *DirectPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectPostRequest(val *DirectPostRequest) *NullableDirectPostRequest {
	return &NullableDirectPostRequest{value: val, isSet: true}
}

func (v NullableDirectPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
