...
// checks if the MerchantBatchReportResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantBatchReportResponse{}

// MerchantBatchReportResponse struct for MerchantBatchReportResponse
type MerchantBatchReportResponse struct {
...
type _MerchantBatchReportResponse MerchantBatchReportResponse
...
func NewMerchantBatchReportResponse(batches []MerchantBatchResponse) *MerchantBatchReportResponse {
	this := MerchantBatchReportResponse{}
...
func (o MerchantBatchReportResponse) MarshalJSON() ([]byte, error) {
...
func (o MerchantBatchReportResponse) ToMap() (map[string]interface{}, error) {
...
func (o *MerchantBatchReportResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varMerchantBatchReportResponse := _MerchantBatchReportResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMerchantBatchReportResponse)

	if err != nil {
		return err
	}

	*o = MerchantBatchReportResponse(varMerchantBatchReportResponse)

	return err
}

type NullableMerchantBatchReportResponse struct {
	value *MerchantBatchReportResponse
	isSet bool
}

func (v NullableMerchantBatchReportResponse) Get() *MerchantBatchReportResponse {
	return v.value
}

func (v *NullableMerchantBatchReportResponse) Set(val *MerchantBatchReportResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantBatchReportResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantBatchReportResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantBatchReportResponse(val *MerchantBatchReportResponse) *NullableMerchantBatchReportResponse {
	return &NullableMerchantBatchReportResponse{value: val, isSet: true}
}

func (v NullableMerchantBatchReportResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantBatchReportResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
