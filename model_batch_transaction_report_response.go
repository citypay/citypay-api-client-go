...
// checks if the BatchTransactionReportResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BatchTransactionReportResponse{}

// BatchTransactionReportResponse struct for BatchTransactionReportResponse
type BatchTransactionReportResponse struct {
	// The count of items returned in this page.
	Count *int32          `json:"count,omitempty"`
	Data  []AuthReference `json:"data"`
...
type _BatchTransactionReportResponse BatchTransactionReportResponse
...
func NewBatchTransactionReportResponse(data []AuthReference) *BatchTransactionReportResponse {
	this := BatchTransactionReportResponse{}
	this.Data = data
	return &this
}
...
func (o BatchTransactionReportResponse) MarshalJSON() ([]byte, error) {
...
func (o BatchTransactionReportResponse) ToMap() (map[string]interface{}, error) {
...
func (o *BatchTransactionReportResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varBatchTransactionReportResponse := _BatchTransactionReportResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBatchTransactionReportResponse)

	if err != nil {
		return err
	}

	*o = BatchTransactionReportResponse(varBatchTransactionReportResponse)

	return err
}

type NullableBatchTransactionReportResponse struct {
	value *BatchTransactionReportResponse
	isSet bool
}

func (v NullableBatchTransactionReportResponse) Get() *BatchTransactionReportResponse {
	return v.value
}

func (v *NullableBatchTransactionReportResponse) Set(val *BatchTransactionReportResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBatchTransactionReportResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBatchTransactionReportResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBatchTransactionReportResponse(val *BatchTransactionReportResponse) *NullableBatchTransactionReportResponse {
	return &NullableBatchTransactionReportResponse{value: val, isSet: true}
}

func (v NullableBatchTransactionReportResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBatchTransactionReportResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
