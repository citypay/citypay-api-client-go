...
// checks if the RetrieveRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RetrieveRequest{}

// RetrieveRequest struct for RetrieveRequest
...
type _RetrieveRequest RetrieveRequest
...
func (o RetrieveRequest) MarshalJSON() ([]byte, error) {
...
func (o RetrieveRequest) ToMap() (map[string]interface{}, error) {
...
func (o *RetrieveRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varRetrieveRequest := _RetrieveRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRetrieveRequest)

	if err != nil {
		return err
	}

	*o = RetrieveRequest(varRetrieveRequest)

	return err
}

type NullableRetrieveRequest struct {
	value *RetrieveRequest
	isSet bool
}

func (v NullableRetrieveRequest) Get() *RetrieveRequest {
	return v.value
}

func (v *NullableRetrieveRequest) Set(val *RetrieveRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableRetrieveRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableRetrieveRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRetrieveRequest(val *RetrieveRequest) *NullableRetrieveRequest {
	return &NullableRetrieveRequest{value: val, isSet: true}
}

func (v NullableRetrieveRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRetrieveRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
