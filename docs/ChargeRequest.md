...
`func (o *ChargeRequest) GetPreAuth() string`

GetPreAuth returns the PreAuth field if non-nil, zero value otherwise.

### GetPreAuthOk

`func (o *ChargeRequest) GetPreAuthOk() (*string, bool)`
...
`func (o *ChargeRequest) SetPreAuth(v string)`

SetPreAuth sets PreAuth field to given value.

### HasPreAuth

`func (o *ChargeRequest) HasPreAuth() bool`
